...
import HeroImage from "../images/Screenshot 2023-11-29 140631.png";
      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full text-center md:text-left md:w-1/2">
          ...
          <p className="text-gray-500 py-4 max-w-md">
            "I'm a fresh mind eager to dive into the world of software development.
            I love to work on web applications using technologies like React, Tailwind, Redux, JavaScript,
          </p>
        ...
        <div className="md:w-1/3 mx-20 mt-10">
          <img
            src={HeroImage}
            alt="my profile"
